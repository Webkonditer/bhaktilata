...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            {{--<!-- /.box-header -->--}}
            <!-- form start -->
                <form role="form" name="edit" action="{{ route('admin.project.category.store', ['category' => $category]) }}" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="edit[parent_id]" id="parent_id" class="form-control">
