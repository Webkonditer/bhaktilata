...
<div class="row">
    <div class="col-sm-12">
        <a href="{{ route('admin.course.category.add') }}" class="btn btn-primary">Добавить категорию</a>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
            ...
            <tbody>
                @foreach($categories as $category)
                    <tr role="row">
                        ...
                        <td>{{ $category->slug }}</td>
                        <td><a href="{{ route('admin.course.category.edit', ['category' => $category]) }}"><i class="icon glyphicon glyphicon-pencil"></i></a></td>
                        <td><a href="{{ route('admin.course.category.delete', ['course' => $category]) }}"><i class="icon glyphicon glyphicon-remove"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
