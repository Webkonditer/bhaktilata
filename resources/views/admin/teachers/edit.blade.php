...
@section('crumbs')<li class="active">Редактирование преподавателя</li>@endsection
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <form role="form" name="edit" action="{{ route('admin.teachers.update', $teacher)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description"
                                  ...
                                  rows="5"
                                  cols="80">
                                  @if(old('description')){{old('description')}} @else{{$teacher->description}} @endif
                       </textarea>
                    </div>
